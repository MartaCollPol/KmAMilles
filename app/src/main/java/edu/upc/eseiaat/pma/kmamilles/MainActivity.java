...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_millas = (Button) findViewById(R.id.btn_a_millas);
        Button btn_km = (Button) findViewById(R.id.btn_a_km);
        ...
        btn_km.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String skm = String.format(Locale.getDefault(), "%f", km);
                edit_km.setText(skm);

            }
        });
        btn_millas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String skm = edit_km.getText().toString();
                float km = Float.parseFloat(skm);
                float millas = km / 1.609f;
                String smillas = String.format(Locale.getDefault(),"%f",millas);
